...
from app.core.metadata.calculation_metadata import CalculationMetadata, CalculationType
...
class MetadataInjectorMiddleware(BaseHTTPMiddleware):
    ...
    def _generate_metadata(self, path: str, response_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        metadata = {"endpoint": path, "calculation_info": {}, "sources": []}
...
def add_metadata_to_response(response_data: Dict[str, Any], calc_type: CalculationType, **kwargs) -> Dict[str, Any]:
    """
