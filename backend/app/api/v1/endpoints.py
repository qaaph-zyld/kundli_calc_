...
async def monitor_requests(request: Request, call_next):
    ...
    monitoring.track_request(endpoint=str(request.url.path), method=request.method, duration=duration)
...
async def get_metrics() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "system_metrics": {"cpu_usage": 45.2, "memory_usage": 62.8, "disk_usage": 78.1, "network_latency": 12.3},
            "performance_metrics": {
...
async def calculate(request: CalculationRequest) -> CalculationResponse:
    ...
    try:
        ...
        return {"error": "Invalid request", "message": "One or more fields are invalid"}
