...
def custom_openapi(app: FastAPI):
    ...
    openapi_schema["info"]["x-logo"] = {"url": "https://example.com/logo.png"}  # Replace with actual logo URL

    # Add tags metadata
    openapi_schema["tags"] = [
        {"name": "Charts", "description": "Operations for calculating and managing birth charts"},
        {"name": "Horoscope", "description": "Operations for horoscope analysis and predictions"},
    ]
