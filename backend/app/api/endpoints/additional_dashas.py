...
async def calculate_chara_dasha(request: DashaRequest) -> Dict[str, Any]:
    ...
    try:
        ...
        chara = CharaDasha()
        result = chara.calculate_dasha_at_birth(birth_time, request.ascendant_longitude, request.planet_longitudes)
...
async def calculate_all_systems(request: DashaRequest) -> Dict[str, Any]:
    ...
    try:
        ...
        result = calculate_all_dasha_systems(
            birth_time, request.moon_longitude, request.ascendant_longitude, request.planet_longitudes
        )
...
async def get_current_running_dasha(request: CurrentDashaRequest) -> Dict[str, Any]:
    ...
    try:
        ...
        result = get_current_dasha_all_systems(
            birth_time, request.moon_longitude, request.ascendant_longitude, request.planet_longitudes, current_time
        )

        return {"success": True, "query_time": current_time.isoformat(), "current_dashas": result}
...
async def get_yogini_antardasha(
    ...
    try:
        ...
        return {"success": True, "mahadasha": yogini, "antardashas": result}
...
async def get_ashtottari_antardasha(
    ...
    try:
        ...
        return {"success": True, "mahadasha": planet, "antardashas": result}
