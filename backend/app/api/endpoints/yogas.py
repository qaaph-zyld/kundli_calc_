...
class YogaRequest(BaseModel):
    ...
    planets: Dict[str, Dict[str, Any]] = Field(
        ..., 
        description="Planet data with longitude, sign, house"
    )
    houses: Dict[int, List[str]] = Field(
        ..., 
        description="House to planet list mapping"
    )
...
async def calculate_all_yogas(request: YogaRequest) -> YogaResponse:
    ...
    try:
        ...
        yogas = calculate_yogas(
            ...
            houses=houses,
            ascendant_sign=request.ascendant_sign
        )
...
async def get_yoga_categories() -> Dict[str, Any]:
    ...
    return {
        ...
        "categories": {
            "raja": {
                "name": "Raja Yoga",
                "description": "Power, authority, and success yogas",
                "nature": "benefic"
            },
            "dhana": {
                "name": "Dhana Yoga", 
            ...
            "nabhasa": {
                "name": "Nabhasa Yoga",
                "description": "Celestial pattern yogas",
                "nature": "varies"
            },
            "special": {
                "name": "Special Yogas",
...
async def list_all_yogas() -> Dict[str, Any]:
    ...
    yoga_list = [
        ...
        {"name": "Bhadra Yoga", "category": "mahapurusha", "planet": "Mercury", "brief": "Intelligence and communication"},
        ...
        # Neecha Bhanga
        {"name": "Neecha Bhanga Raja Yoga", "category": "neecha_bhanga", "planet": "Debilitated", "brief": "Rise after struggles"},
        
        # Others
        {"name": "Saraswati Yoga", "category": "special", "planet": "Jupiter/Venus/Mercury", "brief": "Learning and wisdom"},
    ...
    return {
        "success": True,
        "total_yogas_detectable": len(yoga_list),
        "yogas": yoga_list
    }
...
async def check_specific_yoga(
    request: YogaRequest,
    yoga_name: str = Query(..., description="Name of yoga to check")
) -> Dict[str, Any]:
    """
