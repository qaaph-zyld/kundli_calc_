...
from app.core.knowledge.engine.contextual_synthesis_engine import ContextualInterpretation, ContextualSynthesisEngine
...
async def get_contextual_interpretation(request: ContextualRequest):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Error generating contextual interpretation: {str(e)}")
...
async def get_contextual_capabilities():
    ...
    return {
        ...
        "factors_analyzed": ["house_placement", "sign_dignity", "lordship", "aspects", "yogas", "dasha_period"],
        "strength_assessment": {
