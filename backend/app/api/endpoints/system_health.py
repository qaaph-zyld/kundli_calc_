...
async def health_check() -> Dict[str, Any]:
    ...
    Returns:
        Health status
    """
    return {"status": "healthy", "timestamp": datetime.utcnow().isoformat(), "service": "kundli-calculator"}
...
async def detailed_health_check() -> Dict[str, Any]:
    ...
    return {
        ...
        "performance": {"calculations_tracked": len(perf_stats), "operations": perf_stats},
        "cache": cache_stats,
    }
...
async def readiness_check() -> Dict[str, Any]:
    ...
    checks = {"service": True, "calculations": True, "cache": True}
