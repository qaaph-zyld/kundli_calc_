...
from .framework import Aspect, AyanamsaSystem, CelestialBody, CoordinateSystem, House, ZodiacSign
...
HOUSE_SIGNIFICATIONS: Dict[House, Dict[str, Any]] = {
    ...
    House.SIXTH: {"name": "Ari", "keywords": ["health", "service", "enemies", "debts"], "area": "health and service"},
    House.SEVENTH: {
        "name": "Yuvati",
...
ASPECT_PROPERTIES: Dict[Aspect, Dict[str, Any]] = {
    ...
    Aspect.SEXTILE: {"angle": 60, "orb": 6, "nature": "harmonious", "quality": "opportunities", "strength": "mild"},
    Aspect.SQUARE: {
        "angle": 90,
        "orb": 8,
        "nature": "challenging",
    ...
    Aspect.TRINE: {"angle": 120, "orb": 8, "nature": "harmonious", "quality": "flow and ease", "strength": "strong"},
    Aspect.OPPOSITION: {
        "angle": 180,
        "orb": 10,
        "nature": "challenging",
