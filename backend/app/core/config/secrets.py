...
class SecretsManager:
    ...
    def _get_development_secrets(self, path: str) -> Dict[str, str]:
        ...
        dev_secrets = {
            "kundli/database": {"mongodb_url": "mongodb://localhost:27017", "redis_url": "redis://localhost:6379/0"},
            "kundli/jwt": {"secret_key": "dev-secret-key-never-use-in-production", "algorithm": "HS256"},
            "kundli/ssl": {"cert_path": "/etc/ssl/certs/dummy.crt", "key_path": "/etc/ssl/private/dummy.key"},
        }
