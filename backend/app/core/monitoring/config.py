...
from .framework import AlertRule, AlertSeverity, MetricConfig, MetricType, MonitoringConfig
...
def get_monitoring_config() -> MonitoringConfig:
    ...
    metrics: Dict[str, MetricConfig] = {
        ...
        "cache_hits_total": MetricConfig(
            name="cache_hits_total", type=MetricType.COUNTER, description="Total cache hits"
        ),
        "cache_misses_total": MetricConfig(
            name="cache_misses_total", type=MetricType.COUNTER, description="Total cache misses"
        ),
        # System metrics
        ...
        "system_disk_usage": MetricConfig(
            name="system_disk_usage", type=MetricType.GAUGE, description="System disk usage percentage", labels=["path"]
        ),
    ...
    alerts: Dict[str, AlertRule] = {
        ...
        "high_memory_usage": AlertRule(
            ...
            duration=300,
            labels={"type": "system"},
            annotations={"summary": "High memory usage", "description": "Memory usage is above 80%"},
        ),
        "high_disk_usage": AlertRule(
            ...
            duration=3600,
            labels={"type": "system"},
            annotations={"summary": "High disk usage", "description": "Disk usage is above 85%"},
        ),
        # Application alerts
        "high_error_rate": AlertRule(
            ...
            annotations={"summary": "High error rate", "description": "Error rate is above 10 per 5 minutes"},
        ),
        "slow_response_time": AlertRule(
            ...
            duration=300,
            labels={"type": "application"},
            annotations={"summary": "Slow response time", "description": "Response time is above 5 seconds"},
        ),
