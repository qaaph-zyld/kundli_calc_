...
from .framework import DiscoveryConfig, RegistryType, ServiceEndpoint, ServiceInstance, ServiceMetadata, ServiceStatus
...
def create_service_instance(
    name: str, host: str, port: int, environment: str, region: str = "us-east-1", datacenter: str = "dc1"
) -> ServiceInstance:
    ...
    metadata = ServiceMetadata(
        ...
        tags=[name, environment, region, datacenter, "vedic-astrology"],
        endpoints=endpoints,
    )
