...
RIN_CONDITIONS = {
    KarmicDebt.PITRA_RIN: {
        ...
        "remedies_hindi": ["पितरों को तर्पण करें", "पीपल के पेड़ में जल चढ़ाएं", "काले तिल का दान करें"],
        "remedies_english": ["Perform Tarpan for ancestors", "Offer water to Peepal tree", "Donate black sesame seeds"],
    },
    KarmicDebt.MATA_RIN: {
        "description": "Debt to mother - affects peace and prosperity",
        "conditions": [("Moon", [8, 12], "afflicted"), ("Venus", [4], "afflicted"), ("Rahu", [4], "present")],
        "effects": [
            "Mental unrest",
        ...
        "remedies_hindi": ["माँ का आशीर्वाद लें", "चांदी का छोटा टुकड़ा बहते पानी में बहाएं", "सफेद चीजों का दान करें"],
        "remedies_english": [
    ...
    KarmicDebt.STREE_RIN: {
        ...
        "conditions": [("Venus", [6, 8], "afflicted"), ("Moon", [7], "afflicted"), ("Saturn", [7], "present")],
        "effects": ["Marital discord", "Delay in marriage", "Problems from female relatives", "Reproductive issues"],
        "remedies_hindi": ["पत्नी का सम्मान करें", "सफेद गाय को रोटी खिलाएं", "जवार का दान करें"],
        "remedies_english": ["Respect wife and women", "Feed white cow with bread", "Donate sorghum (jowar)"],
    },
    KarmicDebt.BRAHMAN_RIN: {
        "description": "Debt to teachers/priests - affects wisdom and career",
        "conditions": [("Jupiter", [10], "afflicted"), ("Ketu", [9], "present"), ("Mercury", [9], "afflicted")],
        "effects": [
            "Career obstacles",
        ...
        "remedies_hindi": ["गुरुजनों का सम्मान करें", "पीले रंग की चीजों का दान करें", "केसर का तिलक लगाएं"],
        "remedies_english": [
...
LAL_KITAB_REMEDIES = {
    "Sun": {
        ...
        "afflicted_houses": {
            7: {"hindi": "पत्नी को सोने की चीज भेंट करें", "english": "Gift gold item to wife"},
            8: {"hindi": "बहते पानी में गुड़ बहाएं", "english": "Flow jaggery in running water"},
            12: {"hindi": "बादाम बहते पानी में बहाएं", "english": "Flow almonds in running water"},
        },
    },
    "Moon": {
        "general": {
        ...
        "afflicted_houses": {
            6: {"hindi": "बांस की जड़ घर में रखें", "english": "Keep bamboo root in home"},
            8: {"hindi": "चांदी की गोली बहते पानी में बहाएं", "english": "Flow silver ball in running water"},
            12: {"hindi": "रात को दूध न पिएं", "english": "Avoid drinking milk at night"},
        },
    },
    "Mars": {
        "general": {
        ...
        "afflicted_houses": {
            4: {"hindi": "शहद का दान करें", "english": "Donate honey"},
            8: {"hindi": "मीठी रोटी कुत्ते को खिलाएं", "english": "Feed sweet bread to dogs"},
            12: {"hindi": "बंदरों को गुड़ खिलाएं", "english": "Feed jaggery to monkeys"},
        },
    },
    "Mercury": {
        "general": {
    ...
    "Jupiter": {
        "general": {
            "hindi": ["पीले रंग की चीजें पहनें", "केसर का तिलक लगाएं", "चने की दाल का दान करें", "गुरुजनों की सेवा करें", "मंदिर में जाएं"],
            "english": [
                "Wear yellow items",
                "Apply saffron tilak",
                "Donate gram dal",
    ...
    "Venus": {
        "general": {
            "hindi": ["सफेद चीजों का दान करें", "गाय को आटा खिलाएं", "पत्नी का सम्मान करें", "जवार का दान करें", "चांदी पहनें"],
            "english": ["Donate white items", "Feed flour to cow", "Respect wife", "Donate sorghum", "Wear silver"],
        }
    },
    "Saturn": {
        "general": {
    ...
    "Rahu": {
        "general": {
            "hindi": ["काली सरसों का दान करें", "मंदिर में जौ चढ़ाएं", "सांप को दूध पिलाएं (पत्थर के)", "चांदी पहनें", "हाथी दांत न रखें"],
            "english": [
...
class LalKitabCalculator:
    ...
    def analyze_chart(self, planet_positions: Dict[str, int]) -> LalKitabChart:  # Planet name -> house number (1-12)
        """
        ...
        # General predictions
        predictions_hindi, predictions_english = self._generate_predictions(planet_analyses, karmic_debts)
    ...
    def _check_karmic_debts(self, planet_positions: Dict[str, int]) -> List[KarmicDebtAnalysis]:
    ...
    def _calculate_overall_score(self, planet_analyses: Dict[str, LalKitabPlanetAnalysis]) -> float:
    ...
    def _generate_predictions(
        self, planet_analyses: Dict[str, LalKitabPlanetAnalysis], karmic_debts: List[KarmicDebtAnalysis]
    ...
    return {
        "planets": {
            planet: {
                ...
                "effects": {"hindi": analysis.effects_hindi, "english": analysis.effects_english},
                "health": analysis.health_indication,
                "strength": analysis.strength_score,
                "needs_remedy": analysis.remedy_needed,
                "remedies": {"hindi": analysis.remedies_hindi, "english": analysis.remedies_english},
            }
        ...
        "karmic_debts": [
            {
                ...
                "remedies": {"hindi": debt.remedies_hindi, "english": debt.remedies_english},
            }
        ...
        "predictions": {"hindi": chart.general_predictions_hindi, "english": chart.general_predictions_english},
...
def get_planet_remedy(planet: str, house: int) -> Dict[str, Any]:
    ...
    return {
        "planet": planet,
        "house": house,
        "general_remedies": {"hindi": general.get("hindi", []), "english": general.get("english", [])},
        "specific_remedy": (
            {"hindi": specific.get("hindi", ""), "english": specific.get("english", "")} if specific else None
        ),
    }
