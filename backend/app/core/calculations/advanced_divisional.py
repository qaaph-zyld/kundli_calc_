...
class D81Calculator:
    ...
    def calculate_all_planets(
        self, planets: Dict[str, float], method: str = "cyclical"
...
class SubDivisionalCalculator:
    ...
    def calculate_sub_divisional(self, longitude: float, m: int, n: int) -> DivisionalPosition:
        """
    ...
    def calculate_all_planets(self, planets: Dict[str, float], m: int, n: int) -> Dict[str, DivisionalPosition]:
...
class CustomDivisionalCalculator:
    ...
    def calculate(self, longitude: float, n: int, method: str = "cyclical") -> DivisionalPosition:
        """
        ...
        return DivisionalPosition(
            planet="", longitude=(dn_sign * 30) + dn_degree, sign=dn_sign, sign_name=SIGNS[dn_sign], degree=dn_degree
        )

    def calculate_all_planets(
        self, planets: Dict[str, float], n: int, method: str = "cyclical"
    ) -> Dict[str, DivisionalPosition]:
...
class AdvancedDivisionalCalculator:
    ...
    def calculate_all(self, planets: Dict[str, float]) -> Dict[str, Any]:
    ...
    def calculate_sub_divisional(self, planets: Dict[str, float], m: int, n: int) -> Dict[str, DivisionalPosition]:
