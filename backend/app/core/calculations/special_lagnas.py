...
class SpecialLagnas:
    ...
    def calculate_all_lagnas(
        ...
        # Hora Lagna
        results["hora_lagna"] = self.calculate_hora_lagna(birth_datetime, ascendant)

        # Ghati Lagna
        results["ghati_lagna"] = self.calculate_ghati_lagna(birth_datetime, ascendant)

        # Bhava Lagna
        results["bhava_lagna"] = self.calculate_bhava_lagna(birth_datetime, ascendant)

        # Varnada Lagna
        results["varnada_lagna"] = self.calculate_varnada_lagna(ascendant, birth_datetime)

        # Sree Lagna
        results["sree_lagna"] = self.calculate_sree_lagna(ascendant, moon_longitude)

        # Pranapada Lagna
        results["pranapada_lagna"] = self.calculate_pranapada_lagna(ascendant, sun_longitude)

        # Indu Lagna
        results["indu_lagna"] = self.calculate_indu_lagna(ascendant, moon_longitude, planets)

        # Bhrigu Bindu
        results["bhrigu_bindu"] = self.calculate_bhrigu_bindu(moon_longitude, planets.get("Rahu", 0))

        return results

    def _create_lagna_result(
        self, name: str, sanskrit: str, longitude: float, ascendant: float, interpretation: str
    ) -> LagnaResult:
    ...
    def calculate_hora_lagna(self, birth_datetime: datetime, ascendant: float) -> LagnaResult:
        """
    ...
    def calculate_ghati_lagna(self, birth_datetime: datetime, ascendant: float) -> LagnaResult:
        """
    ...
    def calculate_bhava_lagna(self, birth_datetime: datetime, ascendant: float) -> LagnaResult:
        """
    ...
    def calculate_varnada_lagna(self, ascendant: float, birth_datetime: datetime) -> LagnaResult:
        """
    ...
    def calculate_sree_lagna(self, ascendant: float, moon_longitude: float) -> LagnaResult:
        """
    ...
    def calculate_pranapada_lagna(self, ascendant: float, sun_longitude: float) -> LagnaResult:
        """
    ...
    def calculate_indu_lagna(self, ascendant: float, moon_longitude: float, planets: Dict[str, float]) -> LagnaResult:
        """
    ...
    def calculate_bhrigu_bindu(self, moon_longitude: float, rahu_longitude: float) -> LagnaResult:
        """
...
def calculate_special_lagnas(
    birth_datetime: datetime, ascendant: float, moon: float, sun: float, planets: Dict[str, float]
    ...
    results = calculator.calculate_all_lagnas(birth_datetime, ascendant, moon, sun, planets)
