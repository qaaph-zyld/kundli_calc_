...
class PredictionEngine:
    ...
    activity_requirements = {
        "business": {"mercury": 0.6, "jupiter": 0.5, "sun": 0.4},
        "marriage": {"venus": 0.7, "jupiter": 0.6, "moon": 0.5},
        "travel": {"mercury": 0.5, "moon": 0.5, "jupiter": 0.4},
        "education": {"jupiter": 0.7, "mercury": 0.6, "venus": 0.4},
        "medical": {"sun": 0.6, "jupiter": 0.5, "mars": 0.4},
        "spiritual": {"jupiter": 0.7, "moon": 0.6, "venus": 0.5},
    }
    ...
    def calculate_muhurta(
        ...
        for planet, required in required_strengths.items():
            ...
            strength_analysis[planet] = {"required": required, "current": current, "suitable": meets_requirement}
    ...
    def find_next_suitable_time(
        ...
        while current_time <= end_time:
            result = cls.calculate_muhurta(current_time, activity_type, planet_positions, planet_strengths)
    ...
    @classmethod
    def analyze_transit_period(
        cls,
        start_time: datetime,
        end_time: datetime,
        planet: str,
        natal_position: float,
        transit_positions: List[Tuple[datetime, float]],
    ) -> Dict[str, any]:
        """
    ...
    def _get_muhurta_name(index: int) -> str:
        ...
        muhurtas = ["Rudra", "Brahma", "Vidya", "Kala", "Siddha", "Amrita", "Chara", "Labha", "Shubha", "Mrityu"]
    ...
    def _calculate_transit_strength(aspects: List[Dict]) -> float:
        ...
        weights = {"Conjunction": 1.0, "Trine": 0.8, "Sextile": 0.6, "Square": -0.5, "Opposition": -0.8}
