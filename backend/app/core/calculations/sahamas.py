...
class SahamaCalculator:
    ...
    def _get_point_longitude(self, point: str, planets: Dict[str, float], ascendant: float) -> float:
    ...
    def calculate_sahama(
        self, sahama_key: str, planets: Dict[str, float], ascendant: float, is_day_birth: bool
    ) -> Optional[Sahama]:
    ...
    def calculate_all_sahamas(
        self, planets: Dict[str, float], ascendant: float, sun_longitude: float
    ) -> Dict[str, Any]:
        """
...
def calculate_sahamas(planets: Dict[str, float], ascendant: float, sun_longitude: float) -> Dict[str, Any]:
