...
class YogaCalculator:
    ...
    def __init__(self):
        ...
        self.planet_relationships = {
            ...
            "Moon": {"friends": ["Sun", "Mercury"], "enemies": ["Saturn"], "neutral": ["Mars", "Jupiter", "Venus"]},
    ...
    def calculate_raj_yoga(
        self, planet_positions: Dict[str, Dict[str, float]], house_positions: Dict[int, List[str]]
    ) -> List[YogaResult]:
        ...
        for trine in trine_houses:
            ...
            if trine_lord_house in quadrant_houses:
                ...
                strength = self._calculate_yoga_strength(trine_lord, trine_lord_house, planet_positions)
    ...
    def calculate_dhana_yoga(
        ...
        for house in wealth_houses:
            ...
            if lord_house in beneficial_houses:
                strength = self._calculate_yoga_strength(lord, lord_house, planet_positions)
    ...
    def calculate_mahapurusha_yoga(self, planet_positions: Dict[str, Dict[str, float]]) -> List[YogaResult]:
        ...
        for planet, houses in self.mahapurusha_conditions.items():
            ...
            if planet_house in houses:
                ...
                if dignity in ["own", "exalted"]:
                    strength = self._calculate_yoga_strength(planet, planet_house, planet_positions)
    ...
    def _get_planet_house(self, planet: str, planet_positions: Dict[str, Dict[str, float]]) -> int:
        """Get the house occupied by a planet"""
        longitude = planet_positions[planet]["longitude"]
        return int(longitude / 30) + 1

    def _get_planet_dignity(self, planet: str, planet_positions: Dict[str, Dict[str, float]]) -> str:
    ...
    def _calculate_yoga_strength(self, planet: str, house: int, planet_positions: Dict[str, Dict[str, float]]) -> float:
        """Calculate the strength of a yoga formation"""
        base_strength = 70  # Base strength

        # Modify based on dignity
        dignity_factor = {"exalted": 1.3, "own": 1.2, "friend": 1.1, "neutral": 1.0, "enemy": 0.9, "debilitated": 0.7}
