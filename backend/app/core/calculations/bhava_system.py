...
class BhavaSystem:
    ...
    def calculate_house_strength(
        cls, house: int, planet_positions: Dict[str, float], aspects: Dict[str, List[int]]
    ) -> Dict[str, any]:
        """
    ...
    @classmethod
    def analyze_lord_placement(cls, house: int, lord_house: int) -> Decimal:
    ...
    @classmethod
    def get_house_relationship(cls, house1: int, house2: int) -> str:
    ...
    @classmethod
    def analyze_bhava_chart(cls, planet_positions: Dict[str, float], aspects: Dict[str, List[int]]) -> Dict[str, any]:
        """
        ...
        for house in range(1, 13):
            analysis[house] = cls.calculate_house_strength(house, planet_positions, aspects)
