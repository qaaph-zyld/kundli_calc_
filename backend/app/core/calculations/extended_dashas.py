...
class NiryanaShodashottariDasha:
    ...
    YEARS = {
        "Sun": 11, "Moon": 5, "Mars": 12, "Mercury": 13,
        "Saturn": 29, "Jupiter": 12, "Rahu": 12, "Venus": 22
    }
...
class PanchottariDasha:
    ...
    YEARS = {
        "Sun": 12, "Moon": 13, "Mars": 8, "Mercury": 17,
        "Saturn": 11, "Jupiter": 22, "Rahu": 8, "Venus": 14
    }
...
class ShatabdikaDasha:
    ...
    YEARS = {
        ...
        "Jupiter": 20, "Mars": 20, "Saturn": 20, "Rahu": 5, "Ketu": 5
    }
...
class DwadashottariDasha:
    ...
    YEARS = {
        "Sun": 7, "Moon": 9, "Mars": 11, "Mercury": 17,
        "Jupiter": 11, "Venus": 21, "Saturn": 21, "Rahu": 15
    }
...
class ShastiHayaniDasha:
    ...
    YEARS = {
        ...
        "Jupiter": 10, "Venus": 10, "Saturn": 10, "Rahu": 3, "Ketu": 3
    }
...
def calculate_all_extended_dashas(
    ...
    results["moola_dasha"] = {
        ...
        "periods": [
            {"ruler": p.ruler, "start": p.start_date.isoformat(), 
