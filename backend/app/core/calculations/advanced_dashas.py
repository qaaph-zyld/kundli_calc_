...
class KalachakraDasha:
    ...
    def calculate(self, birth_time: datetime, moon_longitude: float) -> List[DashaPeriod]:
        ...
        for i, years in enumerate(years_seq):
            ...
            periods.append(
                DashaPeriod(ruler=SIGNS[sign_idx % 12], start_date=current, end_date=end, years=actual_years, level=1)
            )
...
class AshtottariDasha:
    ...
    def calculate(self, birth_time: datetime, moon_longitude: float) -> List[DashaPeriod]:
        ...
        for i, planet in enumerate(sequence):
            ...
            periods.append(DashaPeriod(ruler=planet, start_date=current, end_date=end, years=years, level=1))
            current = end
    ...
    def calculate(self, birth_time: datetime, moon_longitude: float) -> List[DashaPeriod]:
        ...
        for i, planet in enumerate(sequence):
            ...
            for j in range(3):
                ...
                sub_periods.append(
                    DashaPeriod(ruler=sub_planet, start_date=sub_current, end_date=sub_end, years=part_years, level=2)
                )
                sub_current = sub_end

            periods.append(
                DashaPeriod(
                    ruler=planet, start_date=current, end_date=end, years=years, level=1, sub_periods=sub_periods
                )
            )
            current = end
...
class CharaDashaParasara:
    ...
    def calculate(self, birth_time: datetime, ascendant: float, planets: Dict[str, float]) -> List[DashaPeriod]:
        ...
        for i in range(12):
            ...
            periods.append(DashaPeriod(ruler=SIGNS[sign_idx], start_date=current, end_date=end, years=years, level=1))
            current = end
...
class YogardhaDasha:
    ...
    def calculate(self, birth_time: datetime, ascendant: float, moon_longitude: float) -> List[DashaPeriod]:
...
class VarnadaDasha:
    ...
    def calculate(self, birth_time: datetime, ascendant: float, hora_lagna: float) -> List[DashaPeriod]:
...
class TaraDasha:
    ...
    TARA_NAMES = ["Janma", "Sampat", "Vipat", "Kshema", "Pratyak", "Sadhaka", "Vadha", "Mitra", "Parama Mitra"]
...
class SudarsanaChakraDasha:
    ...
    def calculate(
        self, birth_time: datetime, ascendant: float, sun_longitude: float, moon_longitude: float
    ) -> List[DashaPeriod]:
...
class TithiAshtottariDasha:
    ...
    TITHI_LORDS = ["Sun", "Moon", "Mars", "Mercury", "Jupiter", "Venus", "Saturn", "Rahu"] * 4

    YEARS = {"Sun": 6, "Moon": 15, "Mars": 8, "Mercury": 17, "Jupiter": 19, "Venus": 21, "Saturn": 10, "Rahu": 12}

    def calculate(self, birth_time: datetime, sun_longitude: float, moon_longitude: float) -> List[DashaPeriod]:
...
class TithiYoginiDasha:
    ...
    def calculate(self, birth_time: datetime, sun_longitude: float, moon_longitude: float) -> List[DashaPeriod]:
        ...
        for i, yogini in enumerate(sequence):
            ...
            periods.append(DashaPeriod(ruler=yogini, start_date=current, end_date=end, years=years, level=1))
            current = end
...
class PadanathaamsakaDasha:
    ...
    def calculate(self, birth_time: datetime, arudha_lagna: float) -> List[DashaPeriod]:
