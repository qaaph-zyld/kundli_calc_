...
class DashaYoga:
    ...
    yoga_definitions = {
        "Raja Yoga": {
            "combinations": [("Sun", "Jupiter"), ("Moon", "Jupiter"), ("Venus", "Jupiter")],
            "effects": [
        ...
        "Dhana Yoga": {
            "combinations": [("Jupiter", "Venus"), ("Mercury", "Venus"), ("Moon", "Venus")],
            "effects": ["Financial prosperity", "Material gains", "Business success"],
        },
        "Vidya Yoga": {
            "combinations": [("Jupiter", "Mercury"), ("Moon", "Mercury"), ("Venus", "Mercury")],
            "effects": ["Academic success", "Intellectual achievements", "Success in education"],
        },
        "Karma Yoga": {
            "combinations": [("Saturn", "Mars"), ("Saturn", "Sun"), ("Mars", "Sun")],
            "effects": ["Professional success through hard work", "Recognition in career", "Leadership positions"],
        },
    }

    @classmethod
    def find_active_yogas(
        cls, main_planet: str, sub_planet: str, prat_planet: str = None
        ...
        for yoga_name, yoga_info in cls.yoga_definitions.items():
            for pair in planet_pairs:
                ...
                if pair in yoga_info["combinations"] or tuple(reversed(pair)) in yoga_info["combinations"]:
                    active_yogas.append({"name": yoga_name, "effects": yoga_info["effects"], "planets": list(pair)})

        return active_yogas

    @classmethod
    def calculate_yoga_strength(cls, yoga_name: str, planet_positions: Dict[str, float]) -> Decimal:
        """
    ...
    @classmethod
    def get_yoga_predictions(
        cls, active_yogas: List[Dict[str, List[str]]], planet_positions: Dict[str, float]
    ) -> List[Dict[str, any]]:
        """
