...
class SarvatobhadraChakra:
    ...
    def calculate(self, moon_nakshatra: str, transit_nakshatra: str = None) -> ChakraResult:
        """
...
class KalachakraEnhanced:
    ...
    def calculate(self, moon_nakshatra_idx: int, birth_sign: int) -> ChakraResult:
...
class DurgaChakra:
    ...
    def calculate(self, janma_nakshatra_idx: int, transit_nakshatra_idx: int = None) -> ChakraResult:
        ...
        return ChakraResult(
            ...
            positions={
                ...
                "zones": {zone: [NAKSHATRAS[i] for i in naks] for zone, naks in zones.items()},
...
class AdditionalChakraCalculator:
    ...
    def calculate_all(
        self, moon_nakshatra_idx: int, birth_sign: int, weekday: int, transit_nakshatra_idx: int = None
...
def calculate_additional_chakras(moon_longitude: float, weekday: int = 0) -> Dict[str, Any]:
