...
class LattaCalculator:
    ...
    def analyze_all_lattas(
        ...
        heavily_afflicted = {
            NAKSHATRAS[idx]: planets_list
            for idx, planets_list in latta_by_nakshatra.items()
        ...
        return {
            ...
            "lattas_by_nakshatra": {
                NAKSHATRAS[i]: planets_list
                for i, planets_list in latta_by_nakshatra.items()
                if planets_list
            },
    ...
    def analyze_transit_latta(
        ...
        return {
            ...
            "summary": (
                f"{len(transit_lattas)} transit latta(s) active"
                if transit_lattas else "No transit lattas active"
            )
        }
