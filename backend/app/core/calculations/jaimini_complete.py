...
class JaiminiSystem:
    ...
    def __init__(self):
        ...
        self.planets_for_karakas = ['Sun', 'Moon', 'Mars', 'Mercury', 
                                     'Jupiter', 'Venus', 'Saturn']
    
    def calculate_chara_karakas(
        self,
        planet_positions: Dict[str, float]
    ) -> Dict[CharaKaraka, CharaKarakaResult]:
    ...
    def calculate_chara_dasha(
        ...
        for i in range(12):
            ...
            years = self._calculate_chara_dasha_years(
                sign_num, planet_signs, is_odd
            )
    ...
    def _calculate_chara_dasha_years(
        self,
        sign_num: int,
    ...
    def calculate_arudha_padas(
        ...
        al = self._calculate_single_arudha_pada(
            asc_sign, planet_positions, "Lagna"
        )
        results['AL'] = al
        ...
        for house_num in range(1, 13):
            ...
            pada = self._calculate_single_arudha_pada(
                house_sign, planet_positions, f"House {house_num}"
            )
...
def calculate_complete_jaimini_analysis(
    ...
    dasha_periods = system.calculate_chara_dasha(
        birth_time, ascendant, planet_positions
    )
    ...
    for house in key_houses:
        argala_analysis[f'House_{house}'] = system.calculate_argala(
            house, planet_positions, ascendant
        )
