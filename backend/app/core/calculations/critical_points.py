...
class MrityuBhaga:
    ...
    def __init__(self, system: str = "saravali"):
        self.system = system
        self.mrityu_table = (
            self.MRITYU_BHAGA_SARAVALI if system == "saravali" 
            else self.MRITYU_BHAGA_PHALA_DEEPIKA
        )
...
class Gandanta:
    ...
    def check_planet(
        ...
        return {
            "planet": planet,
            "is_gandanta": False,
            "interpretation": f"{planet} is not in Gandanta"
        }
    ...
    def check_all_planets(
        ...
        return {
            ...
            "summary": f"{len(gandanta_planets)} planet(s) in Gandanta" if gandanta_planets else "No planets in Gandanta"
        }
...
class Vargottama:
    ...
    def check_planet(
        self,
        planet: str,
        rasi_longitude: float,
        navamsa_longitude: float = None
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "interpretation": (
                ...
                if is_vargottama else
                f"{planet} is not Vargottama"
            )
        }


def analyze_all_critical_points(
    planets: Dict[str, float],
    moon_longitude: float
) -> Dict[str, Any]:
    """
    ...
    results = {
        ...
        "pushkara_bhaga": {
            planet: pushkara.check_planet(planet, lon).__dict__
            for planet, lon in planets.items()
        },
        ...
        "vargottama": {
            planet: vargottama.check_planet(planet, lon)
            for planet, lon in planets.items()
        }
    }
