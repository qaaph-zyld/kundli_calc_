...
class NarayanaDasha:
    ...
    def _get_sign_duration(self, sign_num: int, planet_signs: Dict[str, int]) -> float:
        """
    ...
    def get_antardasha(self, mahadasha: DashaPeriod, planets: Dict[str, float]) -> List[DashaPeriod]:
...
class SudasaDasha:
    ...
    def calculate(self, birth_time: datetime, sree_lagna: float, planets: Dict[str, float]) -> List[DashaPeriod]:
        """
    ...
    def _get_duration(self, sign_num: int, planet_signs: Dict[str, int], sl_sign: int) -> float:
...
class DwiSaptatiSamaDasha:
    ...
    def is_applicable(self, sun_sign: int, moon_sign: int, ascendant_sign: int) -> bool:
        """
...
class ShoolaDasha:
    ...
    def calculate(
        self, birth_time: datetime, ascendant: float, focus: str = "longevity"  # 'longevity', 'marriage', 'children'
    ) -> List[DashaPeriod]:
...
def calculate_all_jaimini_dashas(
    birth_time: datetime, ascendant: float, planets: Dict[str, float], sree_lagna: float
) -> Dict[str, Any]:
    """
