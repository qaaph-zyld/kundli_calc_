...
class YoginiDasha:
    ...
    def calculate_dasha_at_birth(self, birth_time: datetime, moon_longitude: float) -> Dict[str, Any]:
        ...
        yogini_order = YOGINI_SEQUENCE[starting_yogini_idx:] + YOGINI_SEQUENCE[:starting_yogini_idx]
    ...
    def get_antardasha(self, main_yogini: str, start_date: datetime, end_date: datetime) -> List[Dict[str, Any]]:
...
class AshtottariDasha:
    ...
    def get_antardasha(self, main_planet: str, start_date: datetime, end_date: datetime) -> List[Dict[str, Any]]:
...
class CharaDasha:
    ...
    def calculate_dasha_at_birth(
        self, birth_time: datetime, ascendant_longitude: float, planet_longitudes: Dict[str, float]
    ) -> Dict[str, Any]:
        """
    ...
    def _calculate_sign_duration(self, sign: int, planet_longitudes: Dict[str, float]) -> int:
        """
...
class KalachakraDasha:
    ...
    SAVYA_SEQUENCE = ["Aries", "Taurus", "Gemini", "Cancer", "Scorpio", "Libra", "Virgo", "Leo", "Sagittarius"]

    APSAVYA_SEQUENCE = ["Pisces", "Aquarius", "Capricorn", "Sagittarius", "Leo", "Virgo", "Libra", "Scorpio", "Aries"]
...
def calculate_all_dasha_systems(
    birth_time: datetime, moon_longitude: float, ascendant_longitude: float, planet_longitudes: Dict[str, float]
) -> Dict[str, Any]:
    """
    ...
    return {
        ...
        "chara_dasha": chara.calculate_dasha_at_birth(birth_time, ascendant_longitude, planet_longitudes),
...
def get_current_dasha_all_systems(
    ...
    """
    all_dashas = calculate_all_dasha_systems(birth_time, moon_longitude, ascendant_longitude, planet_longitudes)
