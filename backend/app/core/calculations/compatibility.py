...
class AshtakootMilan:
    ...
    def calculate_compatibility(self, boy_moon_lon: float, girl_moon_lon: float) -> CompatibilityResult:
        """
    ...
    def _check_varna(self, boy_sign: int, girl_sign: int) -> KootaResult:
        ...
        varna_map = {
            ...
            1: 1,
            2: 0,
            3: 3,  # Aries=Ksha, Taurus=Vai, Gemini=Shu, Cancer=Bra
            4: 2,
            5: 1,
            6: 0,
            7: 3,  # Leo=Ksha, Virgo=Vai, Libra=Shu, Scorpio=Bra
            8: 2,
            9: 1,
            10: 0,
            11: 3,  # Sagi=Ksha, Capri=Vai, Aqua=Shu, Pisces=Bra
        }
    ...
    def _check_bhakoot(self, boy_sign: int, girl_sign: int) -> KootaResult:
        ...
        actual = ((boy_sign - girl_sign + 12) % 12 + 1, (girl_sign - boy_sign + 12) % 12 + 1)
...
class ManglikDosha:
    ...
    def check_manglik(self, mars_house: int, ascendant_sign: int) -> Dict[str, Any]:
        """
...
class DashakootMilan:
    ...
    def calculate_dashakoot(self, boy_moon_lon: float, girl_moon_lon: float) -> Dict[str, Any]:
    ...
    def _check_gana(self, boy_nak: int, girl_nak: int) -> KootaResult:
        ...
        elif (boy_gana == "Deva" and girl_gana == "Manushya") or (boy_gana == "Manushya" and girl_gana == "Deva"):
