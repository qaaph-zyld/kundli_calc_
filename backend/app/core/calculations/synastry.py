...
class SynastryAnalyzer:
    ...
    def analyze_synastry(
            ...
            for p2_name, p2_lon in chart2_planets.items():
                ...
                if aspect_type:
                    ...
                    aspects.append(SynastryAspect(
                        ...
                        interpretation=cls._get_aspect_interpretation(
        ...
        return {
            ...
            "key_aspects": [cls._aspect_to_dict(a) for a in sorted(aspects, key=lambda x: x.strength, reverse=True)[:10]],
    ...
    def _identify_relationship_themes(cls, aspects: List[SynastryAspect]) -> List[str]:
        ...
        if any(("Saturn", p) in pair or (p, "Saturn") in pair for pair in planet_pairs for p in ["Sun", "Moon", "Venus"]):
    ...
    def _identify_challenges(cls, challenging_aspects: List[SynastryAspect]) -> List[str]:
        ...
        for aspect in challenging_aspects[:5]:
            if aspect.person1_planet == "Saturn" or aspect.person2_planet == "Saturn":
                ...
                challenges.append(f"Tension between {aspect.person1_planet} and {aspect.person2_planet} requiring compromise")
