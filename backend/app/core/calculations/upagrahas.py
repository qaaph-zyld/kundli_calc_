...
class UpagrahaCalculator:
    ...
    def calculate_gulika(
        cls, birth_datetime: datetime, sunrise_time: datetime, sunset_time: datetime, ascendant: float
    ) -> float:
        """
    ...
    def calculate_all_upagrahas(
        ...
        if all([birth_datetime, sunrise_time, sunset_time, ascendant]):
            try:
                result["Gulika"] = cls.calculate_gulika(birth_datetime, sunrise_time, sunset_time, ascendant)
            except Exception:
    ...
    @classmethod
    def format_upagraha_positions(cls, upagrahas: Dict[str, float]) -> Dict[str, Dict[str, any]]:
        """
