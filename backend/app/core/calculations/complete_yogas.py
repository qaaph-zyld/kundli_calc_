...
class CompleteYogaCalculator:
    ...
    def calculate_all_yogas(self, planets: Dict[str, float], ascendant: float, moon_sign: int = None) -> Dict[str, Any]:
    ...
    def _get_planet_houses(self, planets: Dict[str, float], ascendant: float) -> Dict[str, int]:
        ...
        lagna_sign = int(ascendant / 30)
        return {planet: ((int(lon / 30) - lagna_sign) % 12) + 1 for planet, lon in planets.items()}
    ...
    # RAJA YOGAS (22 types)
    # =========================================================================
    def _check_raja_yogas(self, planet_signs: Dict[str, int], planet_houses: Dict[str, int], lagna: int):
    ...
    def _check_pancha_mahapurusha(self, planet_signs: Dict[str, int], planet_houses: Dict[str, int]):
    ...
    def _check_additional_raja_yogas(self, planet_signs: Dict[str, int], planet_houses: Dict[str, int], lagna: int):
    ...
    # =========================================================================
    def _check_dhana_yogas(self, planet_signs: Dict[str, int], planet_houses: Dict[str, int], lagna: int):
    ...
    def _check_dhana_parivartana(self, planet_signs: Dict[str, int], planet_houses: Dict[str, int], lagna: int):
    ...
    def _check_additional_dhana_yogas(self, planet_signs: Dict[str, int], planet_houses: Dict[str, int], lagna: int):
    ...
    # =========================================================================
    def _check_daridra_yogas(self, planet_signs: Dict[str, int], planet_houses: Dict[str, int], lagna: int):
    ...
    def _check_additional_daridra(self, planet_signs: Dict[str, int], planet_houses: Dict[str, int], lagna: int):
    ...
    # =========================================================================
    def _check_arishta_yogas(self, planet_signs: Dict[str, int], planet_houses: Dict[str, int], lagna: int):
    ...
    def _check_additional_arishta(self, planet_signs: Dict[str, int], planet_houses: Dict[str, int], lagna: int):
    ...
    def _check_special_yogas(
        self, planet_signs: Dict[str, int], planet_houses: Dict[str, int], lagna: int, planets: Dict[str, float]
    ):
        ...
        if (
            merc_house in [1, 2, 4, 5, 7, 9, 10]
            and jup_house in [1, 2, 4, 5, 7, 9, 10]
            and ven_house in [1, 2, 4, 5, 7, 9, 10]
        ):
            self.yogas_found.append(
                Yoga(
                    name="Saraswati Yoga",
    ...
    def _check_additional_special(self, planet_signs: Dict[str, int], planet_houses: Dict[str, int], lagna: int):
    ...
    # NABHASA YOGAS
    # =========================================================================
    def _check_nabhasa_yogas(self, planet_signs: Dict[str, int], planet_houses: Dict[str, int]):
    ...
    # CHANDRA (MOON) YOGAS
    # =========================================================================
    def _check_chandra_yogas(self, planet_signs: Dict[str, int], planet_houses: Dict[str, int], moon_sign: int):
        ...
        planets_2nd = [
            ...
            if h == (moon_house % 12) + 1 and p not in ["Sun", "Moon", "Rahu", "Ketu"]
        ]
        planets_12th = [
            p
            for p, h in planet_houses.items()
            if h == (moon_house - 2) % 12 + 1 and p not in ["Sun", "Moon", "Rahu", "Ketu"]
        ]
    ...
    # SOLAR YOGAS
    # =========================================================================
    def _check_solar_yogas(self, planet_signs: Dict[str, int], planet_houses: Dict[str, int]):
        """Check Sun-based yogas"""
        sun_house = planet_houses.get("Sun", 0)

        # Veshi Yoga
        planets_2nd_sun = [
            p for p, h in planet_houses.items() if h == (sun_house % 12) + 1 and p not in ["Moon", "Rahu", "Ketu"]
        ]
        if planets_2nd_sun:
            self.yogas_found.append(
                Yoga(
        ...
        # Voshi Yoga
        planets_12th_sun = [
            p for p, h in planet_houses.items() if h == (sun_house - 2) % 12 + 1 and p not in ["Moon", "Rahu", "Ketu"]
        ]
        if planets_12th_sun:
            self.yogas_found.append(
                Yoga(
...
def calculate_complete_yogas(planets: Dict[str, float], ascendant: float) -> Dict[str, Any]:
