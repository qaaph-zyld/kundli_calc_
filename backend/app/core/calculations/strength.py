...
class EnhancedPlanetaryStrengthEngine:
    def __init__(self):
        ...
        # Motional strengths
        self.motional_strength_rules = {"fast": 60, "normal": 30, "slow": 15, "retrograde": 45}

        # Aspect strengths
        self.aspect_strengths = {"conjunction": 100, "opposition": 50, "trine": 75, "square": 25, "sextile": 37.5}

    def _calculate_shadbala_components(self, planet: Planet, chart: Chart) -> Dict[str, float]:
        """
    ...
    def _calculate_drik_bala(self, planet: Planet, chart: Chart) -> float:
        ...
        for aspect in chart.aspects:
            if aspect["planet1"] == planet.name:
                aspect_strength += self.aspect_strengths.get(aspect["aspect"], 0)
        return aspect_strength

    def _calculate_vimshopaka_components(self, planet: Planet, chart: Chart) -> Dict[str, float]:
        """
    ...
    def _calculate_special_strengths(self, planet: Planet, chart: Chart) -> Dict[str, float]:
        """
    ...
    def _calculate_exaltation_strength(self, planet: Dict[str, Any]) -> float:
        ...
        exaltation_points = {
            "Sun": {"sign": 0, "degree": 10, "debilitation_sign": 6},  # Aries  # Libra
            "Moon": {"sign": 1, "degree": 3, "debilitation_sign": 7},  # Taurus  # Scorpio
            "Mars": {"sign": 9, "degree": 28, "debilitation_sign": 3},  # Capricorn  # Cancer
            "Mercury": {"sign": 5, "degree": 15, "debilitation_sign": 11},  # Virgo  # Pisces
            "Jupiter": {"sign": 3, "degree": 5, "debilitation_sign": 2},  # Cancer  # Gemini
            "Venus": {"sign": 11, "degree": 27, "debilitation_sign": 5},  # Pisces  # Virgo
            "Saturn": {"sign": 6, "degree": 20, "debilitation_sign": 0},  # Libra  # Aries
        }
    ...
    def _calculate_moolatrikona_strength(self, planet: Dict[str, Any]) -> float:
        ...
        moolatrikona_ranges = {
            "Sun": {"sign": 4, "start": 0, "end": 20},  # Leo
            "Moon": {"sign": 1, "start": 3, "end": 30},  # Taurus
            "Mars": {"sign": 0, "start": 0, "end": 12},  # Aries
            "Mercury": {"sign": 5, "start": 15, "end": 20},  # Virgo
            "Jupiter": {"sign": 8, "start": 0, "end": 10},  # Sagittarius
            "Venus": {"sign": 6, "start": 0, "end": 15},  # Libra
            "Saturn": {"sign": 10, "start": 0, "end": 20},  # Aquarius
        }
    ...
    def _apply_strength_aggregation(self, strength_components: Dict[str, Dict[str, float]]) -> Dict[str, float]:
        """
    ...
    def calculate_complete_strengths(self, planet: Planet, chart: Chart) -> Dict[str, Any]:
