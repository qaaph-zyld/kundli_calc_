...
class AyanamsaCalculator:
    ...
    def _initialize_systems(self):
        ...
        self.systems["deluce"] = AyanamsaSystem(
            name="DeLuce", base_date=self.BASE_DATE_1900, base_value=22.90, annual_rate=self.ANNUAL_PRECESSION
        )

        # 8. Sassanian - Ancient Persian system
        self.systems["sassanian"] = AyanamsaSystem(
            name="Sassanian", base_date=self.BASE_DATE_1900, base_value=21.36, annual_rate=self.ANNUAL_PRECESSION
        )

    def calculate_ayanamsa(self, date: datetime, system: str = "lahiri") -> float:
        """
    ...
    def get_all_systems(self, date: datetime) -> Dict[str, float]:
        ...
        """
        return {name: system.calculate(date) for name, system in self.systems.items()}
    ...
    def tropical_to_sidereal(self, tropical_longitude: float, date: datetime, system: str = "lahiri") -> float:
        """
    ...
    def sidereal_to_tropical(self, sidereal_longitude: float, date: datetime, system: str = "lahiri") -> float:
        """
