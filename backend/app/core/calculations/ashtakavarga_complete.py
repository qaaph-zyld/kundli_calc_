...
class AshtakavargaSystem:
    ...
    def calculate_individual_ashtakavarga(
        self, planet: str, planet_positions: Dict[str, float], ascendant: float  # Longitudes in degrees
    ) -> AshtakavargaResult:
    ...
    def calculate_sarvashtakavarga(self, planet_positions: Dict[str, float], ascendant: float) -> Dict[str, Any]:
    ...
    def _interpret_sarvashtakavarga(self, bindus: List[int]) -> Dict[str, str]:
        ...
        for i, (house, b) in enumerate(zip(house_names, bindus)):
            ...
            interpretations[house] = {"bindus": b, "strength": strength, "interpretation": interpretation}

        return interpretations

    def apply_trikona_shodhana(self, sarva_bindus: List[int]) -> List[int]:
        ...
        # Four trine sets
        trine_sets = [[0, 4, 8], [1, 5, 9], [2, 6, 10], [3, 7, 11]]  # 1-5-9  # 2-6-10  # 3-7-11  # 4-8-12
    ...
    def apply_ekadhipatya_shodhana(self, individual_results: Dict[str, AshtakavargaResult]) -> Dict[str, List[int]]:
    ...
    def calculate_prastara_ashtakavarga(self, planet_positions: Dict[str, float], ascendant: float) -> Dict[str, Any]:
        ...
        for planet in self.planets:
            ...
            prastara[planet] = {"total_bindus": result.bindus_per_house, "contributions": contribution_matrix}

        return prastara


def calculate_complete_ashtakavarga(
    planet_positions: Dict[str, float], ascendant: float, apply_reductions: bool = False
) -> Dict[str, Any]:
    ...
    result["prastara_ashtakavarga"] = system.calculate_prastara_ashtakavarga(planet_positions, ascendant)
