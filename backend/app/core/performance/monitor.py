...
class PerformanceMonitor:
    ...
    def __init__(self, window_size: int = 1000):
        ...
        self._metrics: Dict[MetricType, deque] = {metric: deque(maxlen=window_size) for metric in MetricType}
    ...
    async def record_metric(self, metric_type: MetricType, value: float) -> None:
        ...
        metric_data = MetricData(
            value=value, timestamp=datetime.utcnow(), threshold_exceeded=self._check_threshold(metric_type, value)
        )
