...
HARMONIC_RELATIONSHIPS = {
    ...
    3: {"name": "Trine", "meaning": "Flow, Harmony, Integration", "keywords": ["creativity", "expression", "growth"]},
    4: {
        "name": "Square",
    ...
    10: {"name": "Decile", "meaning": "Opportunity, Aspiration", "keywords": ["potential", "development", "growth"]},
    12: {
        "name": "Dodecile",
...
# Dignity scores
DIGNITY_SCORES = {"RULERSHIP": 5, "EXALTATION": 4, "TRIPLICITY": 3, "TERM": 2, "FACE": 1, "DETRIMENT": -5, "FALL": -4}
...
# Aspect orbs
ASPECT_ORBS = {
    Aspect.CONJUNCTION: {"major_bodies": 10.0, "minor_bodies": 8.0, "nodes": 6.0},
    Aspect.OPPOSITION: {"major_bodies": 10.0, "minor_bodies": 8.0, "nodes": 6.0},
    Aspect.TRINE: {"major_bodies": 8.0, "minor_bodies": 6.0, "nodes": 4.0},
    Aspect.SQUARE: {"major_bodies": 8.0, "minor_bodies": 6.0, "nodes": 4.0},
    Aspect.SEXTILE: {"major_bodies": 6.0, "minor_bodies": 4.0, "nodes": 2.0},
}
...
def get_math_config(environment: str) -> Dict[str, Any]:
    ...
    if environment == "local":
        base_config["math_config"].update({"topocentric": False, "true_positions": False, "harmonic_analysis": False})

    elif environment == "development":
        base_config["math_config"].update({"topocentric": True, "true_positions": True, "harmonic_analysis": True})
        ...
        base_config["math_config"].update(
            {
                ...
                "precision": {"longitude": 8, "latitude": 8, "distance": 10, "speed": 10},
            }
        )
