...
class DashaEffects:
    ...
    def interpret_dasha_period(
        cls, main_planet: str, sub_planet: Optional[str] = None, prat_planet: Optional[str] = None
    ) -> Dict[str, List[str]]:
        """
        ...
        """
        interpretation = {"main_effects": cls.get_planet_effects(main_planet), "combinations": []}

        if sub_planet:
            interpretation["sub_effects"] = cls.get_planet_effects(sub_planet)
            interpretation["combinations"].extend(cls.get_combination_effects(main_planet, sub_planet))

        if prat_planet and sub_planet:
            interpretation["prat_effects"] = cls.get_planet_effects(prat_planet)
            interpretation["combinations"].extend(cls.get_combination_effects(sub_planet, prat_planet))
    ...
    def get_strength_factors(cls, planet: str) -> Dict[str, Decimal]:
        ...
        base_factors = {
            "Sun": {
                ...
                "season": {"summer": Decimal("1.3"), "winter": Decimal("0.7")},  # Strong in summer  # Weak in winter
            },
            "Moon": {
                "day": Decimal("0.8"),
                "night": Decimal("1.2"),
                "phase": {"full": Decimal("1.5"), "new": Decimal("0.5")},
            },
            "Mars": {
                "day": Decimal("1.1"),
                "night": Decimal("0.9"),
                "season": {"summer": Decimal("1.2"), "winter": Decimal("0.8")},
            },
            "Mercury": {"day": Decimal("1.0"), "night": Decimal("1.0"), "retro": Decimal("0.8")},
            "Jupiter": {
                "day": Decimal("1.1"),
                "night": Decimal("0.9"),
            ...
            "Venus": {
                "day": Decimal("0.9"),
                "night": Decimal("1.1"),
                "season": {"spring": Decimal("1.3"), "autumn": Decimal("1.1")},
            },
            "Saturn": {"day": Decimal("0.8"), "night": Decimal("1.2"), "retro": Decimal("1.1")},
            "Rahu": {"day": Decimal("0.9"), "night": Decimal("1.1"), "eclipse": Decimal("1.5")},
            "Ketu": {"day": Decimal("0.9"), "night": Decimal("1.1"), "eclipse": Decimal("1.5")},
        }
