...
class ErrorMessages:
    ...
    def get_error_response(
        cls, error_code: ErrorCode, field: str = None, additional_context: str = None
    ) -> Dict[str, Any]:
        """
    ...
    def format_validation_error(
        cls, field: str, value: Any, error_code: ErrorCode, additional_info: str = None
    ) -> Dict[str, Any]:
        """
...
def create_validation_error(field: str, value: Any, error_type: str, expected_format: str = None) -> Dict[str, Any]:
    """
    ...
    """
    error = {"error": True, "type": "validation_error", "field": field, "value": str(value), "error_type": error_type}
