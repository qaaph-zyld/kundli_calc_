...
class CalculationLogger:
    ...
    def log_calculation_start(self, calc_type: str, params: Dict[str, Any]) -> None:
        ...
        self.logger.info(
            f"Starting {calc_type} calculation", extra={"extra_data": params, "calculation_type": calc_type}
        )

    def log_calculation_end(self, calc_type: str, duration_ms: float, success: bool = True) -> None:
        """Log end of calculation"""
        self.logger.info(
            f"Completed {calc_type} calculation",
            extra={"calculation_type": calc_type, "duration_ms": duration_ms, "success": success},
        )

    def log_calculation_error(self, calc_type: str, error: Exception, params: Dict[str, Any]) -> None:
        """Log calculation error"""
        self.logger.error(
            f"Error in {calc_type} calculation: {str(error)}",
            extra={"extra_data": params, "calculation_type": calc_type, "success": False},
            exc_info=True,
        )
