...
class DocumentationGenerator:
    ...
    def _setup_logging(self) -> None:
        ...
        logging.basicConfig(
            ...
            handlers=[logging.FileHandler("docs/generation.log"), logging.StreamHandler()],
        )
    ...
    async def generate_all(self) -> Dict[str, Documentation]:
        ...
        try:
            ...
            code_docs = self.doc_generator.generate_code_docs(Path("app"))
            ...
            return {"api": api_docs, "code": code_docs, "architecture": arch_docs}
