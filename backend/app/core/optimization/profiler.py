...
# Metrics
REQUEST_DURATION = Histogram("api_request_duration_seconds", "Request duration in seconds", ["endpoint", "method"])

CALCULATION_DURATION = Histogram(
    "calculation_duration_seconds", "Calculation duration in seconds", ["calculation_type"]
)
...
ACTIVE_CALCULATIONS = Gauge("active_calculations", "Number of active calculations")
        ...
        def decorator(func):
            ...
            async def wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    # Record metrics
                    REQUEST_DURATION.labels(endpoint=endpoint_name, method=func.__name__).observe(duration)
                    ...
                    profile = ProfileResult(
                        ...
                        metadata={"endpoint": endpoint_name, "method": func.__name__, "status": "success"},
                    )
