...
class VedAstroClient:
    ...
    async def get_yoga_predictions(
        self,
        birth_time: datetime,
        latitude: float,
        longitude: float
    ...
    def _load_predictions(self) -> Dict:
        ...
        return {
            "Sun": {
                ...
                "weak": [
                    "May face ego challenges",
                    "Health requires attention",
                    "Father relationship may be strained"
                ]
            },
            "Moon": {
                "strong": [
            ...
            "Jupiter": {
                ...
                "weak": [
                    "Overconfidence may harm",
                    "Legal matters need care",
                    "Liver health attention"
                ]
            },
            "Venus": {
                "strong": [
            ...
            "Ketu": {
                ...
                "weak": [
                    "Sudden losses possible",
                    "Disconnection feelings",
