...
class RedisCache:
    ...
    async def set(self, key: str, value: Any, expire: Optional[int] = None, nx: bool = False, xx: bool = False) -> bool:
        ...
        try:
            ...
            return bool(self._redis.set(key, serialized, ex=expire, nx=nx, xx=xx))
    ...
    async def hash_getall(self, name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {k: json.loads(v) for k, v in mapping.items()}
        except (json.JSONDecodeError, pickle.UnpicklingError, AttributeError):
            return {}
...
class RedisPipeline:
    ...
    async def execute(self) -> List[Any]:
        ...
        try:
            ...
            return [json.loads(result) if isinstance(result, str) else result for result in results]
