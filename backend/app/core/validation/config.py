...
from .framework import ValidationLevel, ValidationScope
...
VALIDATION_THRESHOLDS = {
    ...
    "aspect": {"orb_max": 10, "strength_min": 0, "strength_max": 100},
    "yoga": {"strength_min": 0, "strength_max": 100, "factor_min": 3},
    "dasha": {"strength_min": 0, "strength_max": 100, "duration_min": 1},  # year
    "interpretation": {"strength_min": 0, "strength_max": 100, "factor_min": 2},
}
...
REQUIRED_ELEMENTS = {
    ...
    "domains": ["personality", "career", "relationships", "health", "spirituality"],
}

# Metrics configuration
METRICS_CONFIG = {
    "enabled": True,
    "astronomical": ["mean_planet_speed", "retrograde_count"],
    "mathematical": ["aspect_count", "mean_orb"],
    "astrological": ["yoga_count", "mean_yoga_strength"],
    "interpretative": ["interpretation_completeness", "recommendation_count"],
}
...
def get_validation_config(environment: str) -> Dict[str, Any]:
    ...
    if environment == "local":
        ...
        base_config["validation_config"] = {ValidationLevel.BASIC: VALIDATION_CONFIG[ValidationLevel.BASIC]}
        ...
        base_config["validation_config"][ValidationLevel.STANDARD].update({"debug_mode": True, "log_validations": True})
        ...
        base_config["validation_config"][ValidationLevel.STRICT].update(
            {"optimize_validations": True, "cache_results": True}
        )
        base_config["metrics_config"].update({"store_history": True, "analyze_trends": True})
