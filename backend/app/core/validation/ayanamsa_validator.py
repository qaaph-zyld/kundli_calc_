...
class AyanamsaValidator:
    ...
    def __init__(self):
        ...
        self._valid_systems = {"LAHIRI", "RAMAN", "KRISHNAMURTI", "DJWHAL_KHUL", "YUKTESHWAR", "JN_BHASIN"}
        self._date_bounds = {"min": datetime(1, 1, 1), "max": datetime(9999, 12, 31, 23, 59, 59)}

    def validate_calculation_input(
        self, date: datetime, system: str, apply_nutation: bool
