...
class MantraCharitySystem:
    ...
    MANTRA_DATA = {
        ...
        "Rahu": {
            ...
            "simple": {"text": "Om Rahave Namaha", "translation": "Salutations to Rahu", "count": 18000, "daily": 108},
            "vedic": {
        ...
        "Ketu": {
            ...
            "simple": {"text": "Om Ketave Namaha", "translation": "Salutations to Ketu", "count": 17000, "daily": 108},
            "vedic": {
    ...
    def recommend_mantra(
        self, planet: str, intensity: str = "moderate"  # simple, moderate, intensive
        ...
        procedure = self._get_mantra_procedure(
            planet, data["deity"], mantra_info["text"], daily_count, data["best_time"]
        )
    ...
    def _get_mantra_procedure(self, planet: str, deity: str, mantra: str, count: int, time: str) -> str:
...
def create_complete_remedial_plan(
    weak_planets: List[str], current_mahadasha: str, user_preferences: Optional[Dict[str, Any]] = None
) -> Dict[str, Any]:
