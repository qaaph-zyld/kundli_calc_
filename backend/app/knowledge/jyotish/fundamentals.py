...
SIGNS: Dict[int, Sign] = {
    1: Sign(1, "Aries", "Mesha", "♈", Element.FIRE, Modality.MOVABLE, "Mars", "Head", "East", "Malefic", "Male"),
    2: Sign(
        2,
        "Taurus",
        "Vrishabha",
    ...
    3: Sign(
        3, "Gemini", "Mithuna", "♊", Element.AIR, Modality.DUAL, "Mercury", "Arms/Shoulders", "West", "Neutral", "Male"
    ),
    4: Sign(
        4, "Cancer", "Karka", "♋", Element.WATER, Modality.MOVABLE, "Moon", "Chest/Heart", "North", "Benefic", "Female"
    ),
    5: Sign(5, "Leo", "Simha", "♌", Element.FIRE, Modality.FIXED, "Sun", "Stomach", "East", "Malefic", "Male"),
    6: Sign(
        6, "Virgo", "Kanya", "♍", Element.EARTH, Modality.DUAL, "Mercury", "Intestines", "South", "Neutral", "Female"
    ),
    7: Sign(
        7, "Libra", "Tula", "♎", Element.AIR, Modality.MOVABLE, "Venus", "Lower Abdomen", "West", "Benefic", "Male"
    ),
    8: Sign(
        8, "Scorpio", "Vrischika", "♏", Element.WATER, Modality.FIXED, "Mars", "Genitals", "North", "Malefic", "Female"
    ),
    9: Sign(
        9, "Sagittarius", "Dhanu", "♐", Element.FIRE, Modality.DUAL, "Jupiter", "Thighs", "East", "Benefic", "Male"
    ),
    10: Sign(
        10,
        "Capricorn",
    ...
    12: Sign(
        12, "Pisces", "Meena", "♓", Element.WATER, Modality.DUAL, "Jupiter", "Feet", "North", "Benefic", "Female"
    ),
}
...
PLANETS: Dict[str, Planet] = {
    ...
    "Rahu": Planet(
        ...
        debilitation=8,
        moolatrikona=0,
        mt_degrees=(0, 0),  # No MT for nodes
...
NAKSHATRAS: Dict[int, Nakshatra] = {
    ...
    10: Nakshatra(
        10, "Magha", "Pitris", "Throne", "Ketu", ["Leo", "Leo", "Leo", "Leo"], "Rakshasa", "Rakshasa", "Rat", "Fierce"
    ),
    11: Nakshatra(
        11,
        "Purva Phalguni",
    ...
    21: Nakshatra(
        ...
        "Elephant Tusk",
        "Sun",
        ["Sagittarius", "Capricorn", "Capricorn", "Capricorn"],
        "Manushya",
        "Manushya",
        "Mongoose",
        "Fixed",
    ...
    23: Nakshatra(
        ...
        "Drum/Flute",
        "Mars",
        ["Capricorn", "Aquarius", "Aquarius", "Aquarius"],
        "Rakshasa",
        "Rakshasa",
        "Lion",
        "Movable",
